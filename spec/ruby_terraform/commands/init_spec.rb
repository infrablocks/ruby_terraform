...
describe RubyTerraform::Commands::Init do
  ...
  it_behaves_like(
    'a command with a flag', [terraform_command, :force_copy]
  )
  ...
  it_behaves_like(
    'a command with an option', [terraform_command, :from_module]
  )

  it_behaves_like(
    'a command with an option', [terraform_command, :plugin_dir]
  )

  it_behaves_like(
    'a command with an argument', [terraform_command, :path]
  )
  ...
  it_behaves_like(
    'a command with a boolean option', [terraform_command, :get]
  )
end
